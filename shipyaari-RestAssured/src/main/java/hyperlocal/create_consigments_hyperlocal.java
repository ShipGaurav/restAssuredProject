...
public class create_consigments_hyperlocal {

	
	public static String[] partnerIds = {"21124", "18664","18665"};
        ...
        for (String orderId : orderIds) {
            ...
            try {
                ...
                given().queryParam("avnkey", "5934@5181").header("Content-Type", "text/plain")
                        .body(payload.crate_consigments_hyperlocal(encodedData, encodedPartnerId)).log().all()
               .when()
